...
export function ProjectSwitcher() {
  ...
  return (
    <Link
      ...
      className="mx-3 mt-3 flex items-center justify-between rounded-lg border border-border bg-surface px-3 py-2 text-left transition-colors hover:border-border-hover hover:bg-surface-hover"
    >
      <div className="flex flex-col">
        <span className="text-[11px] uppercase tracking-wide text-muted">Project</span>
        <span className="text-sm font-medium">
          {activeProject ? activeProject.name : "No project connected"}
        </span>
      </div>
